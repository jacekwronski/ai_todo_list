defmodule AiTodoListWeb.TodoLiveTest do
  use AiTodoListWeb.ConnCase

  import Phoenix.LiveViewTest
  import AiTodoList.TodosFixtures

  @create_attrs %{completed: true, embedding: "some embedding", text: "some text"}
  @update_attrs %{completed: false, embedding: "some updated embedding", text: "some updated text"}
  @invalid_attrs %{completed: false, embedding: nil, text: nil}
